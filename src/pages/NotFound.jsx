				...
				s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z"/>
					...
					278.436,375.599 383.003,264.076 364.393,251.618 264.807,364.928 				"/>
                        ...
                        <StyledGrid item xs={12} md={6}>
                            ...
                            <Typography paragraph={true}>La page que vous recherchez n'existe pas.
                                Comment vous êtes arrivé ici est un mystère. Mais vous pouvez cliquer sur le bouton
                                ci-dessous
                                pour revenir à la page des parties</Typography>
